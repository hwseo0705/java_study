...
public class DFS_Baekjoon_11724 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int N = Integer.parseInt(st.nextToken()); // 정점의 수 : Vertex
        int M = Integer.parseInt(st.nextToken()); // 간선의 수 : Edge
        
        // 정점의 수만큼 인접리스트 내부에 1차원 배열들을 추가
        for (int i = 0; i < N; i++) {
        ...
        for (int i = 0; i < M; i++) {
            ...
            int s = Integer.parseInt(st.nextToken()); // departure
            int e = Integer.parseInt(st.nextToken()); // destination
