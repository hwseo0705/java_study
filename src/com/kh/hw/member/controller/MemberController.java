...
public class MemberController {
    ...
    public MemberController() {
        ...
        m[3] = new Member("jkl", "김철수", "6544", "ghi@naver.com", 'M', 44);
        m[4] = new Member("mno", "김철수", "6544", "ghi@naver.com", 'M', 44);
        m[5] = new Member("pqr", "김철수", "6544", "ghi@naver.com", 'M', 44);
        m[6] = new Member("stu", "김철수", "6544", "ghi@naver.com", 'M', 44);
        m[7] = new Member("vwx", "김철수", "6544", "ghi@naver.com", 'M', 44);
        m[8] = new Member("yzz", "김철수", "6544", "ghi@naver.com", 'M', 44);
        m[9] = new Member("aaa", "김철수", "6544", "ghi@naver.com", 'M', 44);
    }
    ...
    public Member[] searchName(String name) {
        Member[] names = new Member[existMemberNum()];
        int index = 0;
        for (Member member : m) {
            if (member == null) break;
            if (member.getName().equals(name)) names[index++] = member;
        }
    ...
    public boolean updatePassword(String id, String newPassword) {
        int idIdx = findIndexById(id);
        if (idIdx != -1) {
            m[idIdx].setPassword(newPassword);
            return true;
        }
        return false;
    }
    ...
    private void deleteAndFix(int index) {
        int i;
