...
public class MemberMenu {
    ...
    public void mainMenu() {
        while (true) {
            ...
            while (loop) {
                ...
                switch (menu) {
                    case 1:
                        if (mc.existMemberNum() < 10) insertMember();
                        loop = false;
                        break;
                    case 2:
                        searchMember();
    ...
    public void searchId() {
        ...
        Member target = mc.searchId(id);
        if (target == null) {
            System.out.println("검색 결과가 없습니다.");
        } else {
            System.out.println("찾으신 회원 조회 결과입니다.");
            System.out.println(target.inform());
        }
    }
    ...
    public void searchName() {
        ...
        String name = sc.nextLine();
        Member[] target = mc.searchName(name);
        if (target == null) {
            System.out.println("검색 결과가 없습니다.");
        } else {
            System.out.println("찾으신 회원 조회 결과입니다.");
            for (Member member : target) {
                if (member != null) System.out.println(member.inform());
            }
        }
    }
    ...
    public void searchEmail() {
        ...
        String email = sc.nextLine();
        Member target = mc.searchEmail(email);
        if (target == null) {
            System.out.println("검색 결과가 없습니다.");
        } else {
            System.out.println("찾으신 회원 조회 결과입니다.");
    ...
    public void updatePassword() {
        ...
        String pwd = sc.nextLine();
        Boolean success = mc.updatePassword(id, pwd);
        if (!success) {
            System.out.println("검색 결과가 없습니다.");
        } else {
    ...
    public void deleteOne() {
        ...
        if (yes.equalsIgnoreCase("y")) {
            ...
            if (delete) System.out.println("성공적으로 삭제하였습니다.");
    ...
    public void printAll() {
        if (mc.existMemberNum() == 0) System.out.println("저장된 회원이 없습니다.");
